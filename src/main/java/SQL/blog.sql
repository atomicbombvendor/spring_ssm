...
VALUES(1,'第一部分','liyan',1001,'测试,Java','这是一篇测试','<h2 id="section-1">第一部分</h2>
...
INSERT INTO BLOG(user_id,title,author,type,label,decoration,content,state)
VALUES(1,'第二部分','liyan',1001,'测试,Java','这是一篇测试','<h2 id="section-2">第二部分</h2>
...
INSERT INTO BLOG(user_id,title,author,type,label,decoration,content,state)
VALUES(1,'第三部分','liyan',1001,'测试,Java','这是一篇测试','<h2 id="section-3">第三部分</h2>
...
INSERT INTO BLOG(user_id,title,author,type,label,decoration,content,state)
VALUES(1,'第四部分','liyan',1001,'测试,Java','这是一篇测试','<h2 id="section-4">第四部分</h2>
...
INSERT INTO BLOG(user_id,title,author,type,label,decoration,content,state)
VALUES(1,'第五部分','liyan',1001,'测试,Java','这是一篇测试','<h2 id="section-5">第五部分</h2>
